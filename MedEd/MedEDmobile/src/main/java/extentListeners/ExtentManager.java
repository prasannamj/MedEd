...
public class ExtentManager {
	...
	private static ExtentReports extent;
	    ...
	    public static ExtentReports createInstance(String fileName) {
	        ...
	        extent.setSystemInfo("Automation Tester", "Prasanna Kumar");
	        extent.setSystemInfo("Organization", "Enhanzed education Pvt Ltd");
	        extent.setSystemInfo("Build no", "MedED-1.0");
